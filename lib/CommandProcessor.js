...
class CommandProcessor {
    ...
    constructor(repository, commandHandlerFactory) {
        ...
        logger.trace('CommandProcessor() repository=' + JSON.stringify(repository));
        logger.trace('CommandProcessor() commandHandlerFactory=' + JSON.stringify(commandHandlerFactory));
    }

...
class CommandProcessor {
    ...
    process(command) {
        ...
        try {
            ...
            persistOrDelete(newEntity, this.repository);
 ...
 */
function persistOrDelete(newEntity, repository) {
    if (newEntity) {
        //console.log('[cmd+ctrl] saving entity ' + JSON.stringify(newEntity));
        repository.save(newEntity);
    } else {
        //console.log('[cmd+ctrl] deleting entity ' + JSON.stringify(newEntity));
